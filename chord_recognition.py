...
def chord_recognition_main(audio_path, output_path, chord_dict="submission"):
    """
    Main function for chord recognition that can be imported and used by other packages.

    Args:
        audio_path (str): Path to the input audio file
        output_path (str): Path to save the output chord labels
        chord_dict (str): Chord dictionary to use ('submission', 'ismir2017', 'full', 'extended')
    """
    return chord_recognition(audio_path, output_path, chord_dict)
